...
const Catalog = ({ navigation }: ScreenProps<"Catalog">) => {
  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
      <View style={styles.searchbar}>
        <TextInput 
          ...
          onEndEditing={() => console.log("Stop", search)}
          placeholderTextColor="#8BB970"
          placeholder="Поиск"
          style={styles.searchInput}
        />
        <Svg width="20" height="20" viewBox="0 0 84 84" fill="#8BB970">
    ...
    <ProductCard 
        description="ksdjflk jskld jfkldsjf jsdklj flksjd jfalsdj f;lksdj flkasdj fljsda; ljsljl skjlldf jlksdj fldskj " 
        image="dmAaMZoz5-unsplash.jpg"
